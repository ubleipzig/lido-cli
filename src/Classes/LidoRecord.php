<?php
/**
 * Lido - Record extending LidoRecord of NatLibFi class for LIDO Records
 *
...
class LidoRecord extends NativeLidoRecord implements LidoRecordInterface
{
    /**
